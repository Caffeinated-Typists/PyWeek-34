...
class GameView(arcade.View):
    ...
    def on_update(self, delta_time: float):
        ...
        self.scene.update([LAYER_PROTAGONIST, LAYER_BULLETS, LAYER_UFO, LAYER_CRAWLER, LAYER_SPACESHIP])
        ...
        if (time() - self.spaceship_last_seen) > SPACESHIP_FREQ:
